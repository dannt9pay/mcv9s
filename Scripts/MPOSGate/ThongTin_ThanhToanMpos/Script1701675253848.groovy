...
WebUI.verifyElementText(findTestObject('ThanhToan/Page_Mpos/b_Ninh07'), 'Ninh07')

WebUI.verifyElementText(findTestObject('ThanhToan/Page_Mpos/div_1902087908'), '1902087908')

WebUI.verifyElementText(findTestObject('ThanhToan/Page_Mpos/div_19 to huu'), '19 to huu')

WebUI.verifyElementText(findTestObject('ThanhToan/Page_Mpos/div_ninhht9pay.vn'), 'ninhht@9pay.vn')
